    ...
    return (
        ...
        >
            <Side
                title='Lore'
            >
                <textarea onInput={e => setLore(e.currentTarget.value)} className={s.submit__textarea} placeholder='Write HTML lore here'></textarea>
            </Side>
            <Side
                title='Preview'
            >
        ...
        <Row className='grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
            ...
            >
                <Form
                    title="Problem title"
                    input={
                        <input className={s.form__item} type='text' placeholder='Problem title' />
                    }
                ></Form>
            ...
            >
                <Form
                    title="Time limit"
                    input={
                        <input className={s.form__item} type='number' defaultValue={2000} />
                    }
                ></Form>
                <Form
                    title="Memory limit"
                    input={
                        <input className={s.form__item} type='number' defaultValue={65000} />
                    }
                ></Form>
            </Side>
        </Row>
...
function Row({ className, children }: { className?: string, children: any }) {
    return (
        <div className={cn(s.row, className == undefined ? '' : className)}>
            {children}
        </div>
    )
}
